...
void LeaderArray::run(Solution *sol) {
    load_solution(sol);
...
void LeaderArray::two_opt_for_sol() {
...
void LeaderArray::local_improve(Solution *sol, const double& boarder_cost) {
    load_solution(sol);
...
bool LeaderArray::is_accepted_impro(const double &change) {
    return change < - 1.0e-8;
}

bool LeaderArray::perform_intra_move_impro(const std::function<bool(int*, int)>& move_func) const {
    if (num_routes < 1) return false;
...
bool LeaderArray::perform_inter_move_impro(const std::function<bool(int *, int *, int &, int &, int &, int &)> &move_func) {
    if (num_routes <= 1) return false;
...
bool LeaderArray::move1_intra_impro(int* route, int length) {
    if (length <= 4) return false;
...
bool LeaderArray::move1_inter_impro(int* route1, int* route2, int& length1, int& length2, int& loading1, int& loading2) {
    if (length1 < 3 || length2 < 3) return false;
...
bool LeaderArray::move2_intra_impro(int *route, int length) {
    if (length <= 4) return false;
...
bool LeaderArray::move4_intra_impro(int* route, int length) {
    if (length < 5) return false;
...
bool LeaderArray::move2_inter_impro(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2) {
    if (length1 < 4 || length2 < 3) return false;
...
bool LeaderArray::move3_intra_impro(int *route, int length) {
    if (length <= 4) return false;
...
bool LeaderArray::move3_inter_impro(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2) {
    if (length1 < 4 || length2 < 3) return false;
...
bool LeaderArray::move4_inter_impro(int *route1, int *route2, int length1, int length2, int &loading1, int &loading2) {
    if (length1 < 3 || length2 < 3) return false;
...
bool LeaderArray::move5_intra_impro(int *route, int length) {
    if (length < 5) return false;
...
bool LeaderArray::move5_inter_impro(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2) {
    if (length1 < 4 || length2 < 4) return false;
...
bool LeaderArray::move6_intra_impro(int *route, int length) {
    if (length < 6) return false;
...
bool LeaderArray::move6_inter_impro(int *route1, int *route2, int length1, int length2, int &loading1, int &loading2) {
    if (length1 < 4 || length2 < 4 || (length1 == 4 && length2 == 4)) return false;
...
bool LeaderArray::move7_intra_impro(int *route, int length) {
    if (length < 5) return false;
...
bool LeaderArray::move8_inter_impro(int* route1, int* route2, int& length1, int& length2, int& loading1, int& loading2) {
    if (length1 < 3 || length2 < 3) return false;
...
bool LeaderArray::move9_inter_impro(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2) {
    if (length1 < 3 || length2 < 3) return false;
